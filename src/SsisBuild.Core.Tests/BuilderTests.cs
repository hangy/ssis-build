...
public class BuilderTests : IDisposable
{
    ...
    public void Pass_Execute_EchoParametersCoverage()
    {
        ...
        {
            {"Parameter1", BuilderTests.CreateParameter("Parameter1", Fakes.RandomString(), false, ParameterSource.Original)},
            {"SensitiveOriginalParameterNoValue", BuilderTests.CreateParameter("SensitiveOriginalParameterNoValue", null, true, ParameterSource.Original)},
            {"Parameter2", BuilderTests.CreateParameter("Parameter2", Fakes.RandomString(), false, ParameterSource.Configuration)},
            {"SensitiveConfigParameterNoValue", BuilderTests.CreateParameter("SensitiveConfigParameterNoValue", null, true, ParameterSource.Configuration)},
            {"Parameter3", BuilderTests.CreateParameter("Parameter3", Fakes.RandomString(), false, ParameterSource.Manual)}
        };
    ...
    {
        // Setup
        var builder = new Builder(_loggerMock.Object, _projectMock.Object);
        _projectMock.Setup(p => p.Parameters).Returns(new Dictionary<string, IParameter>());
    ...
    private static IParameter CreateParameter(string name, string value, bool sensitive, ParameterSource source)
    {
