...
/* Unmerged change from project 'SsisBuild.Core (net7.0)'
Before:
using System;
After:
...
public class Package : ProjectFile
{
    ...
    private void ResolveProtectionLevel()
    {
        ...
        if (!Enum.TryParse<ProtectionLevel>(protectionLevelValue, true, out var protectionLevel))
    ...
    protected override void EncryptElement(XmlElement element, string password)
    {
        ...
        if (element.FirstChild is XmlElement replacementElement && parentNode != null)
        {
