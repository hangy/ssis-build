...
public class Program
{
    ...
    public static void MainInternal(IBuilder builder, string[] args)
    {
        try
        {
    ...
    private static BuildArguments ParseCommandLineArguments(string[] args)
    {
        ...
        for (var argPos = startPos; argPos < args.Length; argPos += 2)
        {
            ...
            var lookupArgName = ParameterNames.FirstOrDefault(n => n.Equals(argName[1..], StringComparison.InvariantCultureIgnoreCase)) ?? argName[1..];
            ...
            switch (lookupArgName)
            {
                ...
                default:
                    ...
                    {
                        parameters.Add(argName[11..], argValue);
                    }
                    else
                    {
                        throw new InvalidTokenException(argName);
